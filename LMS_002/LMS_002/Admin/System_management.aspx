<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="System_management.aspx.cs" Inherits="LMS_002.Admin.System_management" %>
...
<table cellspacing="0" cellpadding="3" style="width: 100%;"><tbody><tr><td><input type="submit" class="s-btn btn btn-primary" name="updateData" value="บันทึกการตั้งค่า">&nbsp;</td><td class="edit-link-area">&nbsp;&nbsp;</td></tr></tbody></table>
...
<tr id="simbioFormRowlibrary_name" row="1" style="cursor: pointer;"><td width="20%" valign="top" class="alterCell font-weight-bold">ชื่อย่อห้องสมุด</td><td width="1%" valign="top" class="alterCell font-weight-bold">:</td><td width="79%" class="alterCell2"><input type="text" name="library_name" id="library_name" value="PEN1 Library" class="form-control" maxlength="256">
</td></tr>
<tr id="simbioFormRowlibrary_subname" row="2" style="cursor: pointer;"><td width="20%" valign="top" class="alterCell font-weight-bold">ชื่อเต็มห้องสมุด</td><td width="1%" valign="top" class="alterCell font-weight-bold">:</td><td width="79%" class="alterCell2"><input type="text" name="library_subname" id="library_subname" value="Open Source Library Management System" class="form-control" maxlength="256">
</td></tr>
...
<tr id="simbioFormRowopac_result_num" row="5" style="cursor: pointer;"><td width="20%" valign="top" class="alterCell font-weight-bold">ตั้งค่าจำนวนรายการที่แสดงในหน้า OPAC</td><td width="1%" valign="top" class="alterCell font-weight-bold">:</td><td width="79%" class="alterCell2"><select name="opac_result_num" id="opac_result_num" class="form-control col-1">
...
<tr id="simbioFormRowenable_promote_titles" row="6" style="cursor: pointer;"><td width="20%" valign="top" class="alterCell font-weight-bold">แสดงรายการชื่อเรื่องใหม่ในหน้าโฮมเพจ</td><td width="1%" valign="top" class="alterCell font-weight-bold">:</td><td width="79%" class="alterCell2"><div title="class=" form-control="" col-3""=""><input type="checkbox" name="enable_promote_titles[]" value="1" style="border: 0;" checked=""> ใช่</div>
<div class="formElementInfo">class="form-control col-3"</div></td></tr>
<tr id="simbioFormRowquick_return" row="7" style="cursor: pointer;"><td width="20%" valign="top" class="alterCell font-weight-bold">คืน</td><td width="1%" valign="top" class="alterCell font-weight-bold">:</td><td width="79%" class="alterCell2"><select name="quick_return" id="quick_return" class="form-control col-3">
<option value="0">ไม่สามารถใช้งานได้</option>
<option value="1" selected="">สามารถใช้งานได้</option>
</select>
</td></tr>
<tr id="simbioFormRowcirculation_receipt" row="8" style="cursor: pointer;"><td width="20%" valign="top" class="alterCell font-weight-bold">Print Circulation Receipt</td><td width="1%" valign="top" class="alterCell font-weight-bold">:</td><td width="79%" class="alterCell2"><select name="circulation_receipt" id="circulation_receipt" class="form-control col-3">
<option value="0" selected="">Don't Print</option>
<option value="1">Print</option>
</select>
</td></tr>
<tr id="simbioFormRowallow_loan_date_change" row="9" style="cursor: pointer;"><td width="20%" valign="top" class="alterCell font-weight-bold">ยืม และ วันที่คืน</td><td width="1%" valign="top" class="alterCell font-weight-bold">:</td><td width="79%" class="alterCell2"><select name="allow_loan_date_change" id="allow_loan_date_change" class="form-control col-3">
<option value="0">ไม่สามารถใช้งานได้</option>
<option value="1" selected="">สามารถใช้งานได้</option>
</select>
</td></tr>
...
<tr id="simbioFormRowenable_counter_by_ip" row="18" style="cursor: pointer;"><td width="20%" valign="top" class="alterCell font-weight-bold">Visitor Counter by IP</td><td width="1%" valign="top" class="alterCell font-weight-bold">:</td><td width="79%" class="alterCell2"><select name="enable_counter_by_ip" id="enable_counter_by_ip" class="form-control col-3">
<option value="0">ไม่สามารถใช้งานได้</option>
<option value="1" selected="">สามารถใช้งานได้</option>
</select>
</td></tr>
<tr id="simbioFormRowallowed_counter_ip" row="19" style="cursor: pointer;"><td width="20%" valign="top" class="alterCell font-weight-bold">Allowed Counter IP</td><td width="1%" valign="top" class="alterCell font-weight-bold">:</td><td width="79%" class="alterCell2"><textarea name="allowed_counter_ip" id="allowed_counter_ip" style="width: 100%;" class="form-control" maxlength="30720">127.0.0.1</textarea>
</td></tr>
<tr id="simbioFormRowenable_visitor_limitation" row="20" style="cursor: pointer;"><td width="20%" valign="top" class="alterCell font-weight-bold">Visitor Limitation by Time</td><td width="1%" valign="top" class="alterCell font-weight-bold">:</td><td width="79%" class="alterCell2"><select name="enable_visitor_limitation" id="enable_visitor_limitation" class="form-control col-3">
<option value="0" selected="">ไม่สามารถใช้งานได้</option>
<option value="1">สามารถใช้งานได้</option>
</select>
</td></tr>
<tr id="simbioFormRowtime_visitor_limitation" row="21" style="cursor: pointer;"><td width="20%" valign="top" class="alterCell font-weight-bold">Time visitor limitation (in minute)</td><td width="1%" valign="top" class="alterCell font-weight-bold">:</td><td width="79%" class="alterCell2"><input type="text" name="time_visitor_limitation" id="time_visitor_limitation" value="60" style="width: 10%;" class="form-control" maxlength="256">
</td></tr>
