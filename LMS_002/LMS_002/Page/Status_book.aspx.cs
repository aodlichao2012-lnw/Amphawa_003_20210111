...
{
    public partial class Status_book : System.Web.UI.Page
    {
        string profile = "";
        ...
        protected void searchCatalog_ServerClick(object sender, EventArgs e)
        {
            ...
            GridView1.DataSource = Conncetions_db.Connection_command("select * from [dbo].[MD_catralog_book] inner join MD_statusbook on[dbo]." +
                "[MD_catralog_book].int_cheeckin_out = MD_statusbook.self_id where st_process_name_user = '" + profile + "' AND int_cheeckin_out = "+Type.Value+" AND  st_type_book = 0  AND st_name_book LIKE " +
