                ...
                <div class="row">
                    ...
                    <div class="col-md-2 pl-1">
                        <div class="form-group">
                            ...
                            <div> <input type="text" id="min_date" runat="server" class="form-control date-range-filter datepicker w-100" placeholder="From:"></div>
                        </div>
                    </div>
                    <div class="col-md-2 pl-1">
                        <div class="form-group">
                            <label>ยืม ถึงวันที่</label>
                            <div> <input type="text" id="max_date" runat="server" class="form-control date-range-filter datepicker w-100" placeholder="To:"></div>
                        </div>
                    </div>
                </div>
