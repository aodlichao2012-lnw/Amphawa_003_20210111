<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="Login.aspx.cs" Inherits="LMS_002.Page.Login" %>
        ...
        <div class="row">
            <div class=" card">
                ...
                <div class="auto-style3"  >
                    <asp:Button ID="btn_login" runat="server" Text="เข้าสู่ระบบ" OnClick="btn_login_Click" />
                      <asp:Button ID="btn_register" runat="server" Text="ลงทะเบียน" OnClick="btn_register_Click" />
                </div>
